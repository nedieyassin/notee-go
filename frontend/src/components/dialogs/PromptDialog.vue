  ...
  <Transition name="fade">
    <div class="flex fixed justify-center top-0 items-center w-screen h-screen">
      ...
      <div
        ...
        <div class="">
          <form @submit.prevent="closeDialog(text)" class="flex flex-col gap-3 py-2">
            <input v-model="text"
                   :type="type"
                   :placeholder="placeholder"
                   autofocus
                   class="bg-gray-50 outline-none border border-gray-300 text-gray-900 sm:text-sm rounded focus:border-gray-500 block w-full p-2.5">
          </form>
        </div>
